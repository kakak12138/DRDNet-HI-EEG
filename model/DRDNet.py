...
class DRDNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x_avg = x_avg.squeeze(dim=2).permute(0, 2, 1)
        x_max = x_max.squeeze(dim=2).permute(0, 2, 1)
