...
class TransNet(nn.Module):
    def __init__(self, n_classes, num_samples=1000, num_channels=32, embed_dim=32, pool_size=50,
        ...
        self.classify = nn.Linear(embed_dim * temp_embedding_dim, n_classes)
